...
//  Alterar a senha:
  ...
  updateCliente(clienteId: number, cliente: ClienteDetalhesResponse): Observable<any> {
    return this.http.put<any>(`${this.apiUrl}/cliente/${clienteId}`, cliente).pipe(take(1));
  }
